                            ...
                            <div align="center">
                                ...
                                <div style="padding: 0 20px;">
                                    ...
                                    <div
                                        ...
                                        <a href=""
                                            style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;font-size:12px;font-weight:normal">urlTokenSendMail</a>
                                    </div>
                                    <br>
                                    <div
                                        ...
                                        <a href=""
                                            style="font-family:Helvetica,Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;font-weight:bold;color:#005ce4;font-size:14px;font-weight:normal">fromSendMailId</a>.
                                    </div>
                                </div>
                                <br />
                                <br />
